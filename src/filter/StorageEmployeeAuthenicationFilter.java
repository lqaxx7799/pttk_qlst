 ...
 */
@WebFilter({ "/BrowseInvoice", "/ExportInvoice", "/WaitingInvoiceDetail" })
public class StorageEmployeeAuthenicationFilter implements Filter {

    /**
     * Default constructor. 
     */
    public StorageEmployeeAuthenicationFilter() {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		boolean isAdmin = (session != null && session.getAttribute("role") != null
				&& session.getAttribute("role").equals("storageEmployee"));
